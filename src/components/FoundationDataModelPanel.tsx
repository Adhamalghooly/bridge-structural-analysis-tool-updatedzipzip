...
export default function FoundationDataModelPanel({
  ...
  const foundationDb = useMemo(() => {
    return {
      foundations: incomingFoundationDb?.foundations ?? [],
      geometries: incomingFoundationDb?.geometries ?? [],
      assignments: incomingFoundationDb?.assignments ?? [],
      levels: incomingFoundationDb?.levels ?? [],
      soils: incomingFoundationDb?.soils ?? [],
      groups: incomingFoundationDb?.groups ?? [],
    };
